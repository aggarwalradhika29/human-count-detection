...
window = tk.Tk()
window.title("Real-Time Human Detection")
window.iconbitmap('Images/icon.ico')
window.geometry('1000x700')
window.configure(bg='azure3')

# top label
start1 = tk.Label(text = "Real-Time\nHuman Detection", font=("Arial", 50, ),bg='azure3', fg="#4a7abc") # same way bg
start1.place(x = 225, y = 10)
...
Button(window, text="▶ START",command=start_fun,font=("Arial", 25), bg = "white", fg = "black", cursor="hand2", borderwidth=3, relief="raised").place(x =140 , y =570 )

# image on the main window
path1 = "Images/front2.png"
img2 = ImageTk.PhotoImage(Image.open(path1))
panel1 = tk.Label(window, image = img2, bg='azure3')
panel1.place(x = 90, y = 250)

# image on the main window
path = "Images/front1.png"
img1 = ImageTk.PhotoImage(Image.open(path))
panel = tk.Label(window, image = img1,bg='azure3')
...
# exit button created
Button(window, text="❌ EXIT",command=exit_win,font=("Arial", 25), bg = "white", fg = "red", cursor="hand2", borderwidth=3, relief="raised").place(x =610 , y = 570 )
...
if exit1==False:
    ...
    window1 = tk.Tk()
    window1.title("Real Time Human Detection")
